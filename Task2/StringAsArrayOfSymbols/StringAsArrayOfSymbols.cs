...
namespace StringAsArrayOfSymbols
{
    public class StringAsArrayOfSymbols
    {
        private char[] arrayofsymbols;

        public StringAsArrayOfSymbols(string lineforprocessing)
        {
            this.arrayofsymbols = lineforprocessing.ToCharArray();
        }

        public StringAsArrayOfSymbols(char[] arrayofsymbols)
        {
